(function() {
  ...
  angular.module('hz.widget.charts')
    ...
    .directive('kiloPieChart', [ 'WEBROOT', 'horizon.framework.widgets.charts.donutChartSettings', function (WEBROOT, chartSettings) {
      return {
        restrict: 'E',
        scope: {
          chartData: '=',
        ...
        replace: true,
        templateUrl: WEBROOT + 'static/quickstart/templates/pie-chart.html',
