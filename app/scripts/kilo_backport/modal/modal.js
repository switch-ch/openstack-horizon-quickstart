(function() {
  ...
  angular.module('hz.widget.modal', ['ui.bootstrap'])
     ...
     */
    .controller('simpleModalCtrl', [ '$scope', '$uibModalInstance', 'context',
      function($scope, $uibModalInstance, context) {
        $scope.context = context;
        $scope.submit = function(){ $uibModalInstance.close(); };
     ...
     *  ]);
     */
    .factory('simpleModalService', ['$uibModal', 'basePath',
      function($uibModal, path) {
