...
class Quickstart(horizon.Dashboard):
    name = _("Quickstart")
    slug = "quickstart"
    panels = ('instances',)            # Add your panels here.
    default_panel = 'instances'        # Specify the slug of the default panel.


horizon.register(Quickstart)
